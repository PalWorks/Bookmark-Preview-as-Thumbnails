    ...
    <section className="py-24 bg-white" id="pricing">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-md mx-auto">
          <div className="relative p-8 bg-white border border-slate-200 rounded-2xl shadow-xl hover:shadow-2xl transition-shadow duration-300">
            ...
            <div className="mb-6">
              ...
              <p className="text-slate-500 mt-2 text-sm">No credit card required. No hidden fees.</p>
            </div>
