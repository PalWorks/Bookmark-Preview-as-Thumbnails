        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-slate-400">
              ...
              <li><a href="https://github.com/PalWorks/Bookmark-Preview-as-Thumbnails" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Source code</a></li>
            </ul>
          </div>
